...
public:
  ...
  typedef Array<long,encoder_interface_simple::constants::PWM_LEVEL_COUNT_MAX> RecursivePwmValues;
  ...
  typedef Array<RecursivePwmValues,encoder_interface_simple::constants::CHANNEL_COUNT> ChannelsPwmIndexes;
...
private:
  ...
  bool enabled_;
  uint32_t channels_;
  long powers_when_on_[encoder_interface_simple::constants::CHANNEL_COUNT];
  long powers_[encoder_interface_simple::constants::CHANNEL_COUNT];
  long channels_pwm_indexes_[encoder_interface_simple::constants::CHANNEL_COUNT][encoder_interface_simple::constants::PWM_LEVEL_COUNT_MAX];

  EventController<encoder_interface_simple::constants::EVENT_COUNT_MAX> event_controller_;

  IndexedContainer<encoder_interface_simple::constants::PwmInfo,
                   encoder_interface_simple::constants::INDEXED_PWM_COUNT_MAX> indexed_pwm_;
